...
int main(int argc, char** argv)
{
	...
	{
		candle.addMd80(id);
		candle.setupPDO(id, CanopenStack::PDO::TPDO1, {{0x2009, 0x01}, {0x2009, 0x03}, {0x2009, 0x02}});
		candle.setupPDO(id, CanopenStack::PDO::RPDO1, {{0x2008, 0x09}, {0x2008, 0x0B}, {0x2008, 0x0A}});
