...
PYBIND11_MODULE(pyCandle, m)
{
	...
	py::enum_<mab::Md80Reg_E>(m, "Md80Reg_E")
		...
		.value("brakeMode", mab::Md80Reg_E::brakeMode)
	...
	py::class_<mab::CandlePython>(m, "Candle")
		...
		.def("addMd80",
			 &mab::CandlePython::addMd80,
			 py::arg("canID"),
			 py::arg("printFailure") = false)
		...
		.def("controlMd80SetEncoderZero",
			 py::overload_cast<mab::Md80&>(&mab::CandlePython::controlMd80SetEncoderZero))
		.def("controlMd80SetEncoderZero",
			 py::overload_cast<uint16_t>(&mab::CandlePython::controlMd80SetEncoderZero))
		.def("controlMd80Mode",
			 py::overload_cast<mab::Md80&, mab::Md80Mode_E>(&mab::CandlePython::controlMd80Mode))
		.def("controlMd80Mode",
			 py::overload_cast<uint16_t, mab::Md80Mode_E>(&mab::CandlePython::controlMd80Mode))
		.def("controlMd80Enable",
			 py::overload_cast<mab::Md80&, bool>(&mab::CandlePython::controlMd80Enable))
		.def("controlMd80Enable",
			 py::overload_cast<uint16_t, bool>(&mab::CandlePython::controlMd80Enable))
		...
		.def("writeMd80Register",
			 py::overload_cast<uint16_t, mab::Md80Reg_E, std::string>(
				 &mab::CandlePython::writeMd80Register_))
		.def("writeMd80Register",
			 py::overload_cast<uint16_t, mab::Md80Reg_E, float>(
				 &mab::CandlePython::writeMd80Register_))
		.def("writeMd80Register",
			 py::overload_cast<uint16_t, mab::Md80Reg_E, uint32_t>(
				 &mab::CandlePython::writeMd80Register_))
		.def("writeMd80Register",
			 py::overload_cast<uint16_t, mab::Md80Reg_E, int32_t>(
				 &mab::CandlePython::writeMd80Register_))
		.def("readMd80Register",
			 py::overload_cast<uint16_t, mab::Md80Reg_E, char*>(
				 &mab::CandlePython::readMd80Register_))
		.def("readMd80Register",
			 py::overload_cast<uint16_t, mab::Md80Reg_E, float>(
				 &mab::CandlePython::readMd80Register_))
		.def("readMd80Register",
			 py::overload_cast<uint16_t, mab::Md80Reg_E, int64_t>(
				 &mab::CandlePython::readMd80Register_));
}
