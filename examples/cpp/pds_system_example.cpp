...
int main()
{
    ...
    candle.controlMd80Mode(MD_CAN_ID, mab::Md80Mode_E::VELOCITY_PID);  // Set mode to velocity PID
    ...
    while (1)
    {
        ...
        candle.writeMd80Register(
            MD_CAN_ID, Md80Reg_E::targetVelocity, motorRun ? ((float)motorDir * 30.0f) : 0.0f);
