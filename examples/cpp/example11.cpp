...
int main()
{
	...
	// If your UART device is different from the default one ("/dev/ttyAMA0") use the following
	// constructor: mab::Candle candle(mab::CAN_BAUD_8M, true, mab::BusType_E::UART,
	// "/dev/ttyAMA1");
