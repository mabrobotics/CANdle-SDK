...
namespace mab
{
    ...
    */
    enum class propertyId_E : u8
    {
        ...
        OCD_LEVEL                    = 0x40,
        OCD_DELAY                    = 0x41,
        RESET_TOTAL_DELIVERED_ENERGY = 0x42,
    ...
    constexpr std::array<std::pair<propertyId_E, size_t>, 30> propertiesSizeArray = {
        ...
        std::make_pair(propertyId_E::TOTAL_DELIVERED_ENERGY, sizeof(u32)),
        std::make_pair(propertyId_E::TOTAL_RECUPERATED_ENERGY, sizeof(u32)),
        std::make_pair(propertyId_E::RESET_TOTAL_DELIVERED_ENERGY, sizeof(bool)),
