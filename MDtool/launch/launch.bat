C://msys64//mingw64//bin//gdbserver.exe localhost:2000 ./build/Examples/haptic.exe
...
@REM C://msys64//mingw64//bin//gdbserver.exe localhost:2000 ./build/MDtool/MDtool.exe writeSDO 0x2000 0x0d true bool