...
namespace mab
{
	...
	void Md80::__updateResponseData(const State& state) { this->state = state; }
	...
	void Md80::__setControlMode(Md80Mode_E mode) { controlMode = mode; }
	...
	void Md80::packPositionFrame()
	{
		...
		*(float*)&commandFrame.toMd80.data[18] =
			profileVelocityAdjusted ? targets.profileVelocity : NAN;
	...
	void Md80::packMotionTargetsFrame()
	{
		...
		*(float*)&commandFrame.toMd80.data[18] =
			profileVelocityAdjusted ? targets.profileVelocity : NAN;
		*(float*)&commandFrame.toMd80.data[22] =
			profileAccelerationAdjusted ? targets.profileAcceleration : NAN;
	}
