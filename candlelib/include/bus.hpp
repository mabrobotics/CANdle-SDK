...
namespace mab
{
    ...
    class Bus
    {
      public:
        ...
        virtual bool transmit(char* buffer,
                              int   len,
                              bool  waitForResponse = false,
                              int   timeout         = 100,
                              int   responseLen     = 0,
                              bool  faultVerbose    = true) = 0;
        virtual bool transfer(char* buffer, int commandLen, int responseLen);
        virtual bool receive(int  responseLen,
                             int  timeoutMs    = 100,
                             bool checkCrc     = true,
                             bool faultVerbose = true);
      ...
      protected:
        BusType_E                 busType;
        int                       bytesReceived = 0;
        static constexpr uint32_t rxBufferSize  = 1024;
        static constexpr uint32_t txBufferSize  = 1024;
