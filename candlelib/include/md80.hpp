...
namespace mab
{
    ...
    class Md80
    {
      ...
      public:
         ...
         * @note Controller output is target velocity in rad/s. The output is then passed as input
         * to Velocity PID controller.
         ...
         * @note Controller output is Torque in Nm. The output is then passed directly to internal
         ...
         * @note This settings affects all motion modes, and can also be changed using candletool
         * and saved
         ...
         * @return uint16_t vector with per-bit coded statuses. Refer to documentation for meaning
         * of each field.
         */
        uint16_t getQuickStatus()
        {
            return state.quickStatus;
        };
         ...
         * @return float angular position in radians
         */
        float getOutputEncoderPosition()
        {
            return state.outputEncoderPosition;
        };
        /**
         * @brief Get the Velocity of md80
         * @return float angular velocity in rad/s
         */
        float getOutputEncoderVelocity()
        {
            return state.outputEncoderVelocity;
        };
        /**
